...
class Color(Enum):
    DARK_RED = {"id": 0, "hex": "#6D001A"}
    DARK_RED1 = {"id": 1, "hex": "#BE0039"}
    RED = {"id": 2, "hex": "#FF4500"}
    ORANGE = {"id": 3, "hex": "#FFA800"}
    YELLOW = {"id": 4, "hex": "#FFD635"}
    YELLOW1 = {"id": 5, "hex": "#FFF8B8"}
